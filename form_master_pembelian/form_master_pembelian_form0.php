...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_master_pembelian/form_master_pembelian_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_master_pembelian_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_master_pembelian_jquery.php');
 ...
 function toggleBlock(e) {
  ...
  if (show_block[block_id]) {
    if ("hidden_bloco_1" == block_id) {
      scAjaxDetailHeight("form_master_pembelian_detail", "420");
    }
  }
 }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['recarga'];
}
?>
...
<?php
 include_once("form_master_pembelian_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_master_pembelian'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_master_pembelian'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['run_iframe'] != "R")
{
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['Lookup_master_type'][] = '0'; ?>
 <option value="1" <?php  if ($this->master_type == "1") { echo " selected" ;} ?>>Pembelian Traveler Cheque</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['Lookup_master_type'][] = '1'; ?>
 <option value="2" <?php  if ($this->master_type == "2") { echo " selected" ;} ?>>Pembelian Draft</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['Lookup_master_type'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_proc']  = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_form']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_call']  = true;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_multi'] = false;
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_qtd_reg'] = '25';
 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_tp_pag'] = 'parcial';
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_master_pembelian_empty.htm' : $this->Ini->link_form_master_pembelian_detail_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=420');
?>
<iframe border="0" id="nmsc_iframe_liga_form_master_pembelian_detail"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="420" width="100%" name="nmsc_iframe_liga_form_master_pembelian_detail"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_master_pembelian");
 parent.scAjaxDetailHeight("form_master_pembelian", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
