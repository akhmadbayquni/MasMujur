...
<?php
include_once("form_master_pembelian_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_master_pembelian_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['recarga'];
}
?>
...
<?php
 include_once("form_master_pembelian_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_master_pembelian_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_master_pembelian_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_master_pembelian_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['run_iframe'] != "R")
{
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['Lookup_master_type'][] = '0'; ?>
 <option value="1" <?php  if ($this->master_type == "1") { echo " selected" ;} ?>>Pembelian Traveler Cheque</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['Lookup_master_type'][] = '1'; ?>
 <option value="2" <?php  if ($this->master_type == "2") { echo " selected" ;} ?>>Pembelian Draft</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['Lookup_master_type'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php $sStyleHidden_master_total_dumb = ('' == $sStyleHidden_master_total) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_master_total_dumb" style="<?php echo $sStyleHidden_master_total_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_master_pembelian_mob_empty.htm' : $this->Ini->link_form_master_pembelian_detail_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=420');
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_master_pembelian_mob");
 parent.scAjaxDetailHeight("form_master_pembelian_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
