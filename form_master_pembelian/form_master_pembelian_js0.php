...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_master_pembelian"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_Cetak = false;
function sc_btn_Cetak()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_Cetak(); }, 500);
      return;
    }
    if (Crtl_btn_Cetak) {return;}
    Crtl_btn_Cetak = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?Cetak?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian']['where_detal']))
  {
?>  
