...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_master']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_master']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_master']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_master']['total']))
          {
              $_SESSION['sc_session'][$script_case_init]['form_master_detail']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_master_detail']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_master']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_master']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_master']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_master']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_master']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_master']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_master']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_master']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_master']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_master']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_master_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("id");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_master']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_master']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_master'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_master']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_master']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_master') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_master']['label'] = "Form Pembelian Valuta Asing PT. Asmiranda";
      ...
      $_SESSION['scriptcase']['error_icon']['form_master']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_master']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_master']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_master']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_master']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_master']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master']['goto'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_master']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_master']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_master']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_master']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_master']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_master']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_master']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_master']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_master']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_master", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_master/form_master_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_master_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_master_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_master_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_master/form_master_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_master_erro.class.php"); 
      }
      $this->Erro      = new form_master_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_master']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['Cetak'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['botoes']['Cetak'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_master_detail') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_master_detail') . "/form_master_detail_apl.php");
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_redir_atualiz'] == "ok")
          {
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opc_ant'] == "incluir")
      {
      ...
      $this->nm_converte_datas();
      $_SESSION['scriptcase']['form_master']['contr_erro'] = 'on';
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_master']) || !is_array($this->NM_ajax_info['errList']['geral_form_master']))
              {
                  $this->NM_ajax_info['errList']['geral_form_master'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_master'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_master_total(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->master_total, 10, 0, 0, 0, "N") == false)  
              { 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_master_pack_protect_string($this->nmgp_dados_form['id']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'] < 0)
              {
...
$aLookup[] = array(form_master_pack_protect_string('0') => form_master_pack_protect_string("Pembelian Bank Note"));
$aLookup[] = array(form_master_pack_protect_string('1') => form_master_pack_protect_string("Pembelian Traveler Cheque"));
$aLookup[] = array(form_master_pack_protect_string('2') => form_master_pack_protect_string("Pembelian Draft"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['Lookup_master_type'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['Lookup_master_type'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['Lookup_master_type'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['master_type']['valList'][$i] = form_master_pack_protect_string($v);
          }
   ...
   function ajax_return_values_detail($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao'] = '';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_master' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_master']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->detail = $this->detail_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total']);
              }

              $this->sc_evento = "insert"; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_filter_form'];
      }
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_master = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'] = $qt_geral_reg_form_master;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_master = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] > $qt_geral_reg_form_master)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] = $qt_geral_reg_form_master; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_master) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] = 0;
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start']) ;  
              } 
          } 
          ...
          { 
              ...
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] < $qt_geral_reg_form_master;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_master_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_master_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_master_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_master_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['masterValue'] as $cmp_master => $val_master)
{
?>
