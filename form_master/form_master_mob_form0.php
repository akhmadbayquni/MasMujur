...
<?php
include_once("form_master_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_master_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['recarga'];
}
?>
...
<?php
 include_once("form_master_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_master_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_master_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['run_iframe'] != "R")
{
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_ref_line" id="hidden_field_data_master_ref" style="<?php echo $sStyleHidden_master_ref; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_ref_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_master_ref_label"><span id="id_label_master_ref"><?php echo $this->nm_new_label['master_ref']; ?></span></span><br><input type="hidden" name="master_ref" value="<?php echo $this->form_encode_input($master_ref); ?>"><span id="id_ajax_label_master_ref"><?php echo nl2br($master_ref); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_trdate_hora_line" id="hidden_field_data_master_trdate" style="<?php echo $sStyleHidden_master_trdate; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_trdate_hora_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_master_trdate_label"><span id="id_label_master_trdate"><?php echo $this->nm_new_label['master_trdate']; ?></span></span><br><input type="hidden" name="master_trdate" value="<?php echo $this->form_encode_input($master_trdate); ?>"><span id="id_ajax_label_master_trdate"><?php echo nl2br($master_trdate); ?></span>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_type_line" id="hidden_field_data_master_type" style="<?php echo $sStyleHidden_master_type; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_type_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_master_type_label"><span id="id_label_master_type"><?php echo $this->nm_new_label['master_type']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['Lookup_master_type'][] = '0'; ?>
 <option value="1" <?php  if ($this->master_type == "1") { echo " selected" ;} ?>>Pembelian Traveler Cheque</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['Lookup_master_type'][] = '1'; ?>
 <option value="2" <?php  if ($this->master_type == "2") { echo " selected" ;} ?>>Pembelian Draft</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['Lookup_master_type'][] = '2'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_name_line" id="hidden_field_data_master_name" style="<?php echo $sStyleHidden_master_name; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_name_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_master_name_label"><span id="id_label_master_name"><?php echo $this->nm_new_label['master_name']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_address_line" id="hidden_field_data_master_address" style="<?php echo $sStyleHidden_master_address; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_address_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_master_address_label"><span id="id_label_master_address"><?php echo $this->nm_new_label['master_address']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_phone_line" id="hidden_field_data_master_phone" style="<?php echo $sStyleHidden_master_phone; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_phone_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_master_phone_label"><span id="id_label_master_phone"><?php echo $this->nm_new_label['master_phone']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_total_line" id="hidden_field_data_master_total" style="<?php echo $sStyleHidden_master_total; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_total_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_master_total_label"><span id="id_label_master_total"><?php echo $this->nm_new_label['master_total']; ?></span></span><br><input type="hidden" name="master_total" value="<?php echo $this->form_encode_input($master_total); ?>"><span id="id_ajax_label_master_total"><?php echo nl2br($master_total); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_detail_line" id="hidden_field_data_detail" style="<?php echo $sStyleHidden_detail; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_detail_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_detail_label"><span id="id_label_detail"><?php echo $this->nm_new_label['detail']; ?></span></span><br>
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_master_mob_empty.htm' : $this->Ini->link_form_master_detail_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y');
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_master_mob");
 parent.scAjaxDetailHeight("form_master_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
