...
<?php
include_once("form_trans_master_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_trans_master_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['recarga'];
}
?>
...
<?php
 include_once("form_trans_master_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_trans_master'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_trans_master'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_ref_line" id="hidden_field_data_master_ref" style="<?php echo $sStyleHidden_master_ref; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_ref_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_user_input_label" id="hidden_field_label_user_input" style="<?php echo $sStyleHidden_user_input; ?>"><span id="id_label_user_input"><?php echo $this->nm_new_label['user_input']; ?></span></TD>
    <TD class="scFormDataOdd css_user_input_line" id="hidden_field_data_user_input" style="<?php echo $sStyleHidden_user_input; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_user_input_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_name_line" id="hidden_field_data_master_name" style="<?php echo $sStyleHidden_master_name; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_name_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_phone_line" id="hidden_field_data_master_phone" style="<?php echo $sStyleHidden_master_phone; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_phone_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_address_line" id="hidden_field_data_master_address" style="<?php echo $sStyleHidden_master_address; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_address_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_total_line" id="hidden_field_data_master_total" style="<?php echo $sStyleHidden_master_total; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_total_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_master_type_line" id="hidden_field_data_master_type" style="<?php echo $sStyleHidden_master_type; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_type_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_master_jenis_label" id="hidden_field_label_master_jenis" style="<?php echo $sStyleHidden_master_jenis; ?>"><span id="id_label_master_jenis"><?php echo $this->nm_new_label['master_jenis']; ?></span></TD>
    <TD class="scFormDataOdd css_master_jenis_line" id="hidden_field_data_master_jenis" style="<?php echo $sStyleHidden_master_jenis; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_jenis_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_master_trdate_label" id="hidden_field_label_master_trdate" style="<?php echo $sStyleHidden_master_trdate; ?>"><span id="id_label_master_trdate"><?php echo $this->nm_new_label['master_trdate']; ?></span></TD>
    <TD class="scFormDataOdd css_master_trdate_line" id="hidden_field_data_master_trdate" style="<?php echo $sStyleHidden_master_trdate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_trdate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_master_update_label" id="hidden_field_label_master_update" style="<?php echo $sStyleHidden_master_update; ?>"><span id="id_label_master_update"><?php echo $this->nm_new_label['master_update']; ?></span></TD>
    <TD class="scFormDataOdd css_master_update_line" id="hidden_field_data_master_update" style="<?php echo $sStyleHidden_master_update; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_master_update_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_trans_master']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_trans_master");
 parent.scAjaxDetailHeight("form_trans_master", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
