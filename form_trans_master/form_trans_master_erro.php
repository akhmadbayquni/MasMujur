...
$old_error_handler = set_error_handler("form_trans_master_scriptcase_error_handler");

function form_trans_master_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_trans_master']['contr_erro']) && $_SESSION['scriptcase']['form_trans_master']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_trans_master->contr_form_trans_master->Apl_com_erro = true;
            if ($inicial_form_trans_master->contr_form_trans_master->NM_ajax_flag)
            {
                $inicial_form_trans_master->contr_form_trans_master->NM_ajax_info['errList']['geral_form_trans_master'][] = $msg;
                return;
            }
            form_trans_master_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_trans_master_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_trans_master'])  && '' != $_SESSION['scriptcase']['error_icon']['form_trans_master'])  ? $_SESSION['scriptcase']['error_icon']['form_trans_master']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_trans_master']) && '' != $_SESSION['scriptcase']['error_close']['form_trans_master']) ? $_SESSION['scriptcase']['error_close']['form_trans_master'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_trans_master']) && '' != $_SESSION['scriptcase']['error_span_title']['form_trans_master']) ? $_SESSION['scriptcase']['error_span_title']['form_trans_master'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_trans_master']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_trans_master']) ? $_SESSION['scriptcase']['error_icon_title']['form_trans_master'] : '';
?>
