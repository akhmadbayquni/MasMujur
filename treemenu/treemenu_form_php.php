...
<?php
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_master_pembelian") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_4")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_master_penjualan") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_10")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("form_v_valas_2") . "/?nm_run_menu=1&nm_apl_menu=treemenu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "&script_case_session=" . session_id() . "";
      }
      }
      if (!$link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['treemenu']['sc_init'][$apl_menu];
