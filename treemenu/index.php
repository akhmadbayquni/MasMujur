...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_master_pembelian") . "/form_master_pembelian_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_master_pembelian']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_master_pembelian'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_master_penjualan") . "/form_master_penjualan_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_master_penjualan']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_master_penjualan'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_v_valas_2") . "/form_v_valas_2_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_v_valas_2']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_v_valas_2'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Transaksi Pengeluaran";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "Transaksi Selisih Kas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[4]))
{
 ...
 $nm_var_lab[5] = "Selisih Lebih Kas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[5]))
{
 ...
 $nm_var_lab[6] = "Selisih Kurang Kas";
...
$str_disabled = "N";
$str_link = "treemenu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_master_pembelian&sc_apl_link=" . urlencode($treemenu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_master_pembelian']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_master_pembelian']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "treemenu_form_php.php?sc_item_menu=item_4&sc_apl_menu=form_master_penjualan&sc_apl_link=" . urlencode($treemenu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_master_penjualan']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_master_penjualan']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "treemenu_form_php.php?sc_item_menu=item_10&sc_apl_menu=form_v_valas_2&sc_apl_link=" . urlencode($treemenu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['treemenu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_v_valas_2']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_v_valas_2']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
