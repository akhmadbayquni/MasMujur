<?php
//
class form_master_pembelian_detail_apl
{
   ...
   var $form_vert_form_master_pembelian_detail = array();
...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['nm_run_menu'] = 1;
      } 
      if (isset($_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_master_pembelian_detail_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("id");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("id");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_master_pembelian_detail']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_master_pembelian_detail']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_master_pembelian_detail'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_master_pembelian_detail']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_master_pembelian_detail']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_master_pembelian_detail') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_master_pembelian_detail']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - trans_detail";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_master_pembelian_detail")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_master_pembelian_detail']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_master_pembelian_detail'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_master_pembelian_detail']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['exit'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_master_pembelian_detail", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_master_pembelian_detail_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_master_pembelian_detail_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_master_pembelian_detail/form_master_pembelian_detail_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_master_pembelian_detail_erro.class.php"); 
      }
      $this->Erro      = new form_master_pembelian_detail_erro();
      $this->Erro->Ini = $this->Ini;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opcao']))
         { 
             if ($this->id_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['final'];
      }
      else
      {
      }
...
//
   ...
   function controle()
   {
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_master_pembelian_detail']) || !is_array($this->NM_ajax_info['errList']['geral_form_master_pembelian_detail']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_master_pembelian_detail'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_master_pembelian_detail'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_master_pembelian_detail'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_master_pembelian_detail'][] = $this->Campos_Mens_erro;
                  }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_redir_atualiz'] == "ok")
          {
      ...
      { 
         ...
         if (isset($this->amount_exchange_)) { $this->nm_limpa_alfa($this->amount_exchange_); }
         if (isset($this->amount_total_)) { $this->nm_limpa_alfa($this->amount_total_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['id_valas_'] =  $this->id_valas_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_valas_'] =  $this->amount_valas_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_exchange_'] =  $this->amount_exchange_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_total_'] =  $this->amount_total_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['id_'] =  $this->id_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['master_id_'] =  $this->master_id_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_date_'] =  $this->amount_date_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_date__hora'] =  $this->amount_date__hora; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_jenistr_'] =  $this->amount_jenistr_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_type_'] =  $this->amount_type_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_rate_'] =  $this->amount_rate_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_stats_'] =  $this->amount_stats_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_master_pembelian_detail);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form") 
      {
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_master_pembelian_detail'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_id_valas_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
               if (!empty($this->id_valas_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['Lookup_id_valas_']) && !in_array($this->id_valas_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['Lookup_id_valas_']))
               {
    ...
    function ValidateField_amount_exchange_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "Exchange: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->amount_exchange_, 10, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "Exchange; " ; 
                  if (!isset($Campos_Erros['amount_exchange_']))
                  {
                      $Campos_Erros['amount_exchange_'] = array();
                  }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
      ...
      {
          nmgp_Form_Num_Val($this->amount_exchange_, $this->field_config['amount_exchange_']['symbol_grp'], $this->field_config['amount_exchange_']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['amount_exchange_']['symbol_fmt']) ; 
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['id_']['keyVal'] = form_master_pembelian_detail_pack_protect_string($this->nmgp_dados_form['id_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_master_pembelian_detail[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_master_pembelian_detail[$this->nmgp_refresh_row]['id_valas_'] = $this->id_valas_;
                  }
                  if (isset($this->NM_ajax_changed['amount_valas_']) && $this->NM_ajax_changed['amount_valas_'])
                  {
                      $this->form_vert_form_master_pembelian_detail[$this->nmgp_refresh_row]['amount_valas_'] = $this->amount_valas_;
                  }
                  if (isset($this->NM_ajax_changed['amount_exchange_']) && $this->NM_ajax_changed['amount_exchange_'])
                  {
                      $this->form_vert_form_master_pembelian_detail[$this->nmgp_refresh_row]['amount_exchange_'] = $this->amount_exchange_;
                  }
                  if (isset($this->NM_ajax_changed['amount_total_']) && $this->NM_ajax_changed['amount_total_'])
                  {
                      $this->form_vert_form_master_pembelian_detail[$this->nmgp_refresh_row]['amount_total_'] = $this->amount_total_;
                  }
                  if (isset($this->NM_ajax_changed['id_']) && $this->NM_ajax_changed['id_'])
                  {
                      $this->form_vert_form_master_pembelian_detail[$this->nmgp_refresh_row]['id_'] = $this->id_;
                  }
              }
          }
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_master_pembelian_detail);
          foreach($this->form_vert_form_master_pembelian_detail as $sc_seq_vert => $aRecData)
          {
...
ORDER BY nama_valas";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $aLookup[] = array(form_master_pembelian_detail_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_master_pembelian_detail_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_valas_' . $sc_seq_vert]['valList'][$i] = form_master_pembelian_detail_pack_protect_string($v);
          }
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_select'][$sc_seq_vert]['id_valas_'] = $this->id_valas_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_select'][$sc_seq_vert]['amount_valas_'] = $this->amount_valas_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_select'][$sc_seq_vert]['amount_exchange_'] = $this->amount_exchange_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_select'][$sc_seq_vert]['amount_total_'] = $this->amount_total_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_select'][$sc_seq_vert]['id_'] = $this->id_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['db_changed'] = true;
      ...
      { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_I_E']++; 
              $this->NM_gera_nav_page(); 
              $this->NM_ajax_info['navPage'] = $this->SC_nav_page; 
...
ORDER BY nama_valas";
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_master_pembelian_detail_pack_protect_string(NM_charset_to_utf8($this->id_valas_)))
              {
          ...
          $tmpLabel_id_valas_ = $sLabelTemp;
                  ...
                  $this->NM_ajax_info['fldList']['amount_total_' . $this->nmgp_refresh_row]['type']    = 'label';
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = 0; 
              }
    ...
    if ("insert" == $this->sc_evento && $this->nmgp_opcao != "nada") {
        ...
        $_SESSION['scriptcase']['form_master_pembelian_detail']['contr_erro'] = 'on';
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_amount_total_ != $this->amount_total_ || (isset($bFlagRead_amount_total_) && $bFlagRead_amount_total_))&& isset($this->nmgp_refresh_row))
    {
        $this->NM_ajax_info['fldList']['amount_total_' . $this->nmgp_refresh_row]['type']    = 'label';
        $this->NM_ajax_info['fldList']['amount_total_' . $this->nmgp_refresh_row]['valList'] = array($this->amount_total_);
...
$_SESSION['scriptcase']['form_master_pembelian_detail']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['parms'] = "id_?#?$this->id_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_master_pembelian_detail']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['embutida_liga_qtd_reg'];
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_master_pembelian_detail = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter'] . ")";
          }
      }
      $sc_where = "";
      if ('' != $sc_where_filter)
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total']))
          {
              ...
              $qt_geral_reg_form_master_pembelian_detail = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total'] = $qt_geral_reg_form_master_pembelian_detail;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_I_E'] = 0; 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_master_pembelian_detail = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_master_pembelian_detail) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] > $qt_geral_reg_form_master_pembelian_detail)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = $qt_geral_reg_form_master_pembelian_detail - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = ($qt_geral_reg_form_master_pembelian_detail + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['ordem_ord']; 
      } 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['parms'] = "id_?#?$this->id_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['id_valas_'] =  $this->id_valas_; 
             $this->form_vert_form_master_pembelian_detail[$sc_seq_vert]['amount_valas_'] =  $this->amount_valas_; 
          ...
          ksort ($this->form_vert_form_master_pembelian_detail); 
          $rs->Close(); 
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] < (($qt_geral_reg_form_master_pembelian_detail + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['reg_start'] + $this->sc_max_reg;
...
if($this->dataset23 [0][0] < $this->amount_valas_ ) {
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_master_pembelian_detail' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
if(!empty($this->dataset25[0][0]))
{
$rate_awal123 = $this->dataset25[0][0];
} 

$total_pl =  $rate_awal123 - $this->amount_exchange_  ;

     $nm_select ="update trans_detail set amount_stats = $total_pl where id = $this->id_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$amount_total = $this->dataset[0][0];
     ...
     $nm_select ="UPDATE trans_master SET master_total = $amount_total WHERE id = $this->master_id_ "; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         ...
         $rf->Close();
      ; 
nmgp_Form_Num_Val($amount_total, '.', ',', 0, 'S', '1', '');
...
$_SESSION['scriptcase']['form_master_pembelian_detail']['contr_erro'] = 'on';
      ...
      $nm_select = "select stok_valas FROM v_valas where id_valas = $this->id_valas_ "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dataset271 = array();
     if ($this->id_valas_ !== "")
     { 
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          ...
          { 
                 ...
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                      $this->dataset271[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset271 = false;
          $this->dataset271_erro = $this->Db->ErrorMsg();
      } 
     } 
;
 
      $nm_select = "select equivalen FROM v_valas where id_valas = $this->id_valas_ "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dataset272 = array();
     if ($this->id_valas_ !== "")
     { 
      if ($rx = $this->Db->Execute($nm_select)) 
      { 
          ...
          { 
                 ...
                 for ($x = 0; $x < $nm_count; $x++)
                 { 
                      $this->dataset272[$y] [$x] = $rx->fields[$x];
                 }
                 $y++; 
                 $rx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dataset272 = false;
          $this->dataset272_erro = $this->Db->ErrorMsg();
      } 
     } 
;
$awal_stok = $this->dataset271[0][0];
nmgp_Form_Num_Val($awal_stok, '.', ',', 0, 'S', '1', '');
$awal_equiv = $this->dataset272[0][0];
nmgp_Form_Num_Val($awal_equiv, '.', ',', 0, 'S', '1', '');

$input_stok = $this->amount_valas_ ;
$input_equiv = $this->amount_total_ ;

$rate_baru = $input_equiv+$awal_equiv;
$stok_baru= $awal_stok+$input_stok;

$hasil = $rate_baru/$stok_baru;



     $nm_select ="update valas set avg_valas = $hasil where id = $this->id_valas_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_master_pembelian_detail = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['total'] = $qt_geral_reg_form_master_pembelian_detail;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_master_pembelian_detail_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_master_pembelian_detail_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_master_pembelian_detail_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['masterValue']))
{
?>
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_master_pembelian_detail']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
}
?>
